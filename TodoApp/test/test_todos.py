...
def test_create_todo_authenticated(test_todo):
    ...
    response = client.post('todo/create_todo', json=response_data)
...
def test_update_todo_authenticated(test_todo):
    ...
    response = client.put('todo/update_todo/1', json=response_data)
...
def test_update_todo_authenticated_not_found(test_todo):
    ...
    response = client.put('todo/update_todo/999', json=response_data)
...
def test_delete_todo_authenticated_not_found(test_todo):
    response = client.delete('todo/delete_todo/999')
